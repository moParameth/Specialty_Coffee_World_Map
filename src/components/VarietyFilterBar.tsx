...
export default function VarietyFilterBar({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl bg-white/95 backdrop-blur border border-amber-900/10 p-4 shadow-sm lg:flex-row lg:items-center">
      {/* Search Input */}
      <div className="relative flex-1">
        ...
        <input
          type="text"
          className="block w-full rounded-xl bg-slate-50 border border-slate-200 py-2.5 pl-10 pr-3 text-sm text-slate-800 placeholder:text-slate-400 focus:ring-2 focus:ring-amber-500 focus:border-transparent focus:bg-white sm:text-sm transition-all shadow-sm"
      ...
      <div className="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:items-center">
        ...
        <select
          ...
          className="block w-full sm:w-44 rounded-xl bg-slate-50 border border-slate-200 py-2.5 pl-3 pr-8 text-xs font-semibold text-slate-700 focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all shadow-sm"
        >
        ...
        <select
          ...
          className="block w-full sm:w-48 rounded-xl bg-slate-50 border border-slate-200 py-2.5 pl-3 pr-8 text-xs font-semibold text-slate-700 focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all shadow-sm"
        >
        ...
        <button
          onClick={onReset}
          className="col-span-2 sm:col-span-1 flex items-center justify-center gap-2 rounded-xl bg-amber-50 px-4 py-2.5 text-xs font-bold text-amber-900 hover:bg-amber-100 active:scale-98 transition-all border border-amber-200 shadow-sm"
          title="Reset Filters"
        >
